...
<h2>Create new account</h2>
  ...
  <form action="http://localhost/MVCDONE/accountController/createAccount" method="POST">
...
<select name="city" class="form-control" >
   ...
   <option value="Ahemedabad"<?php if(!empty($data['city'])): echo "selected"; endif; ?>>Ahemedabad</option>
	 
   <option value="Surat"<?php if(!empty($data['city'])): echo "selected"; endif; ?>>Surat</option>
	<option value="Toronto"<?php if(!empty($data['city'])): echo "selected"; endif; ?>>Toronto</option>
	<option value="Ottava"<?php if(!empty($data['city'])): echo "selected"; endif; ?>>Ottava</option>
...
<select name="country" class="form-control" >
   <option value="" >Select State:</option>
    ...
    <option value="Gujarat"<?php if(!empty($data['country'])): echo "selected"; endif; ?>>Gujarat</option>
	
   <option value="Canada"<?php if(!empty($data['country'])): echo "selected"; endif; ?>>Canada</option>
</select>
<div class="error">
